...
const createServer = () => {
 ...
 app.get('/aboutme',(req,res)=>{
   res.send('a developer to be ,just one week and i will be a full-stack developer');
  
 });
 app.get('/favoritefoods',(req,res)=>{
   const favourites=['yallange','Maqlube','Mansaf'];
   res.send(favourites);
 })
...
let findShortest = (data) => {
  // Solution code here...
  let shortest = data.reduce((accum, val) => {
